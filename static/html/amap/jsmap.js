...
//var webApiUrl = "http://12.112.102.234:25001/as/webapi/js/auth?v=1.0&t=jsmap&ak="+defaultKey;
...
var demoHash = ["core/map", "core/control", "core/mapstate", "core/changemap", "core/mapto", "core/getmapzoom", "layer/customlayer", "layer/trafficeLayers",
  ...
  "event/removemapclick", "server/searchkey", "layer/traffic", "layer/ningbo22", "layer/ningbo23", "server/nearsearch", "server/rectsearch", "server/suggest", "boundary/roadinfo",


  "geocode/geocode", "geocode/regeocode", "driver/driverforlnglat", "walking/walkingforlnglat", "bus/busnavi",


  "boundary/boundary", "bus/busInfoByName", "roadlevel/roadlevel", "roadlevel/searchreal", "layer/mapTM"
];
