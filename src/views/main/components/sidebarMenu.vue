...
<template>
    <Menu ref="sideMenu" :active-name="$route.name" :open-names="openedSubmenuArr" :theme="$store.getters.menuTheme" width="auto" @on-select="changeMenu">
...
export default {
  ...
  watch: {
    ...
    currentPageName () {
      this.openedSubmenuArr = this.$store.getters.openedSubmenuArr
      this.$nextTick(() => {
