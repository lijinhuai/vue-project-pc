  ...
  <div class="body">
    ...
    <div style="position: absolute; width: calc(100vw - 340px); height: 90%; margin: 30px 340px;">
      ...
      <div v-show="company.zdmb!='1'" class="home-ranking-list" style="width: 570px;height:90vh; margin-left: 420px;">
        ...
        <ul class="data-contents-height" style=" padding: 0px 20px;">
          <li v-for="ry in company.cyry" :key="ry.index">
            <Poptip trigger="hover" :content="ry.lxdh">
              <b style="width:15px;display:inline-block;">{{ry.xh}}</b>
          ...
          <li v-show="company.cyry.length>0" style="float:right;">
      ...
      <div v-show="company.zdmb=='1'" class="home-ranking-list" style="width: 570px;height:90vh; margin-left: 420px;">
        ...
        <ul class="data-contents-height" style=" padding: 0px 20px;">
          <li>
            <label style="width:110px;display:inline-block;">治安管理单位</label> {{company.dwzdxx.zagldw}}
          </li>
          <li>
            <label style="width:110px;display:inline-block;">社区民警</label> {{company.dwzdxx.sqmj}}
          </li>
          <li>
            <label style="width:110px;display:inline-block;">上级主管单位</label> {{company.dwzdxx.sjzgdw}}
          </li>
          <li>
            <label style="width:110px;display:inline-block;">主管领导/联系人</label> {{company.dwzdxx.mbzgld}}
          </li>
          <li>
            <label style="width:110px;display:inline-block;">保安部门负责人</label> {{company.dwzdxx.bafzr}}
          </li>
          <!-- <li>
          ...
          <li>
            <label style="width:110px;display:inline-block;">地理位置</label> {{company.dwzdxx.dlwz}}
          </li>
          <li>
            <label style="width:110px;display:inline-block;">重要部位</label> {{company.dwzdxx.zybw}}
          </li>
        </ul>
      </div>
    </div>
...
<script>
  import {
    fetchCompany, fetchCompanyCyry
  } from '@/api/cxtj/company'
  export default {
    name: 'company',
    data () {
      return {
    ...
    mounted () {
      ...
      if (dwbh) {
        ...
        this.fetchCompanyCyryList()
      }
    },
    methods: {
      fetchCompanyCyryList () {
        fetchCompanyCyry(this.company.dwbh, this.pageInfo).then(response => {
          this.company.cyry = response.data.list
