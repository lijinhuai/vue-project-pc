  ...
  <div class="body">
		...
		<div class="home-ranking-list" style="width: 300px; height: 600px;  margin-left: 340px; border-top: 2px solid #ecc52e;">
                  ...
                  <ul class="data-contents-height" style=" margin-top: -140px; height: 545px;    text-align: left;">
					  ...
					  <li><label>4</label><span> 万盛金邸东区出口右 </span><label class="r" style="background-color: #26bf3e;padding: 0 10px;font-size: 12px;border-radius: 3px;color: whitesmoke;line-height: 26px;margin-top: 10px;">正常</label></li>
					  <li><label>5</label><span> 万盛金邸西区进门右 </span><label class="r" style="background-color: #26bf3e;padding: 0 10px;font-size: 12px;border-radius: 3px;color: whitesmoke;line-height: 26px;margin-top: 10px;">正常</label></li>
					  <li><label>6</label><span> 万盛金邸西区出口左 </span><label class="r" style="background-color: #26bf3e;padding: 0 10px;font-size: 12px;border-radius: 3px;color: whitesmoke;line-height: 26px;margin-top: 10px;">正常</label></li>
					  <li><label>7</label><span> 万盛金邸西区进口左 </span><label class="r" style="background-color: #26bf3e;padding: 0 10px;font-size: 12px;border-radius: 3px;color: whitesmoke;line-height: 26px;margin-top: 10px;">正常</label></li>
					  <li><label>8</label><span> 万盛金邸门洞1 </span><label class="r" style="background-color: #26bf3e;padding: 0 10px;font-size: 12px;border-radius: 3px;color: whitesmoke;line-height: 26px;margin-top: 10px;">正常</label></li>
					  <li><label>9</label><span> 万盛金邸门洞2 </span><label class="r" style="background-color: #26bf3e;padding: 0 10px;font-size: 12px;border-radius: 3px;color: whitesmoke;line-height: 26px;margin-top: 10px;">正常</label></li>
					  <li><label>10</label><span> 万盛金邸西区北门 </span><label class="r" style="background-color: #26bf3e;padding: 0 10px;font-size: 12px;border-radius: 3px;color: whitesmoke;line-height: 26px;margin-top: 10px;">正常</label></li>
					  <li><label>11</label><span> 万盛金邸西区出口右 </span><label class="r" style="background-color: #26bf3e;padding: 0 10px;font-size: 12px;border-radius: 3px;color: whitesmoke;line-height: 26px;margin-top: 10px;">正常</label></li>
                  </ul>
		</div>
		<div class="home-ranking-list" style="width: 300px; height: 600px; margin-left: 650px; border-top: 2px solid #3a7bff;">
                  ...
                  <ul class="data-contents-height" style=" margin-top: -240px; height: 545px;    text-align: left;">
					  ...
					  <li><label>4</label><span> 龙轩路866弄1号楼802室 </span><label class="r" style="background-color: #26bf3e;padding: 0 10px;font-size: 12px;border-radius: 3px;color: whitesmoke;line-height: 26px;margin-top: 10px;">正常</label></li>
					  <li><label>5</label><span> 龙轩路866弄1号楼701室 </span><label class="r" style="background-color: #26bf3e;padding: 0 10px;font-size: 12px;border-radius: 3px;color: whitesmoke;line-height: 26px;margin-top: 10px;">正常</label></li>
					  <li><label>6</label><span> 龙轩路866弄2号楼802室 </span><label class="r" style="background-color: #26bf3e;padding: 0 10px;font-size: 12px;border-radius: 3px;color: whitesmoke;line-height: 26px;margin-top: 10px;">正常</label></li>
					  <li><label>7</label><span> 龙轩路866弄10号701室 </span><label class="r" style="background-color: #26bf3e;padding: 0 10px;font-size: 12px;border-radius: 3px;color: whitesmoke;line-height: 26px;margin-top: 10px;">正常</label></li>
					  <li><label>8</label><span> 龙轩路866弄1号楼702室 </span><label class="r" style="background-color: #26bf3e;padding: 0 10px;font-size: 12px;border-radius: 3px;color: whitesmoke;line-height: 26px;margin-top: 10px;">正常</label></li>
					  <li><label>9</label><span> 龙轩路1000弄10号1001室 </span><label class="r" style="background-color: #26bf3e;padding: 0 10px;font-size: 12px;border-radius: 3px;color: whitesmoke;line-height: 26px;margin-top: 10px;">正常</label></li>
					  <li><label>10</label><span> 龙轩路866弄14号802室 </span><label class="r" style="background-color: #26bf3e;padding: 0 10px;font-size: 12px;border-radius: 3px;color: whitesmoke;line-height: 26px;margin-top: 10px;">正常</label></li>
					  <li><label>11</label><span> 龙轩路866弄1号楼602室 </span><label class="r" style="background-color: #26bf3e;padding: 0 10px;font-size: 12px;border-radius: 3px;color: whitesmoke;line-height: 26px;margin-top: 10px;">正常</label></li>
                  </ul>
		</div>
		<div class="home-ranking-list" style="width: 370px; height: 600px; margin-left: 960px;     border-top: 2px solid #00e66d;">
                  <h4><label>WIFI嗅探</label><label style="float: right; font-size: 14px; color: #00d294;">数量：4</label></h4>
				  ...
				  <ul class="data-contents-height" style=" margin-top: -140px; height: 220px;">
                      <li><label>1</label><span> 万盛金邸西区南门 </span><label>94-88-5E-31-06-E9</label>
					  ...
					  <li><label>2</label><span> 万盛金邸东区南门 </span><label>94-88-5E-31-04-0A</label>
					  <label class="r" style="background-color: #26bf3e;padding: 0 10px;font-size: 12px;border-radius: 3px;color: whitesmoke;line-height: 26px;margin-top: 10px;">正常</label></li>
					  <li><label>3</label><span> 万盛金邸西区北门 </span><label>94-88-5E-30-FD-57</label>
					  <label class="r" style="background-color: #26bf3e;padding: 0 10px;font-size: 12px;border-radius: 3px;color: whitesmoke;line-height: 26px;margin-top: 10px;">正常</label></li>
					  <li><label>4</label><span> 万盛金邸东区北门 </span><label>94-88-5E-31-09-00</label>
					  <label class="r" style="background-color: #26bf3e;padding: 0 10px;font-size: 12px;border-radius: 3px;color: whitesmoke;line-height: 26px;margin-top: 10px;">正常</label></li>
                  </ul>
				  ...
				  <ul class="data-contents-height" style=" margin-top: -30px; height: 260px;">
					  ...
					  <label class="r" style="background-color: #26bf3e;padding: 0 10px;font-size: 12px;border-radius: 3px;color: whitesmoke;line-height: 26px;margin-top: 10px;">正常</label></li>
					  <li><label>3</label><span> 西区 2号北侧 </span><label style="padding-left: 10px;">121.336956,30.750537</label>
					  <label class="r" style="background-color: #26bf3e;padding: 0 10px;font-size: 12px;border-radius: 3px;color: whitesmoke;line-height: 26px;margin-top: 10px;">正常</label></li>
					  <li><label>4</label><span> 西区 6号北侧 </span><label style="padding-left: 10px;">121.336956,30.751263</label>
					  <label class="r" style="background-color: #26bf3e;padding: 0 10px;font-size: 12px;border-radius: 3px;color: whitesmoke;line-height: 26px;margin-top: 10px;">正常</label></li>
					  <li><label>5</label><span> 西区16号北侧 </span><label style="padding-left: 10px;">121.335856,30.750941</label>
					  <label class="r" style="background-color: #26bf3e;padding: 0 10px;font-size: 12px;border-radius: 3px;color: whitesmoke;line-height: 26px;margin-top: 10px;">正常</label></li>
                  </ul>
		</div>
	</div>
