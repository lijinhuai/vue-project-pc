  ...
  <imp-panel>
    ...
    <el-row slot="body" :gutter="24" style="margin-bottom: 20px;">
      <el-col :span="6" :xs="24" :sm="24" :md="6" :lg="6" style="margin-bottom: 20px;">
        <div class="role-tree">
          <el-tree v-if="roleTree" :data="roleTree" ref="roleTree" show-checkbox check-strictly highlight-current default-expand-all @node-click="handleNodeClick" clearable node-key="id" :props="defaultProps">
  ...
  export default {
    ...
    methods: {
      ...
      handleNodeClick (data) {
        ...
        this.form.description = this.form.data.description
      },
      newAdd () {
        this.form = {
          id: null,
